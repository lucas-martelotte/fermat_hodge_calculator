from .formal_algebra import PolynomialRingOverFormalNumberField, FormalNumberField
...
class EvenDimensionalDiagonalVariety:
    def __init__(
        ...
        self.weights = [self.degree // e for e in exps]
        ...
        det_hess_F = prod(mi * (mi - 1) * xi ** (mi - 2) for xi, mi in zip(xs, ms))
